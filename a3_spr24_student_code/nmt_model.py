...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        init_decoder_hidden = self.h_projection(torch.reshape(last_hidden, (last_hidden.shape[0], -1)))
        init_decoder_cell = self.c_projection(torch.reshape(last_cell, (last_cell.shape[0], -1)))
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in Y_split:
            ...
            dec_state, combined_output, e_t = self.step(Ybar_t, dec_init_state, enc_hiddens, enc_hiddens_proj, enc_masks)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        a_t = torch.squeeze(torch.bmm(torch.unsqueeze(alpha_t, -2), enc_hiddens), -2)
