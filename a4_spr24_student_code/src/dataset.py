...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        masked_length = random.randint(1, truncate_length//2 - 1)
        prefix_length = random.randrange(truncate_length - masked_length)
        ...
        # pads_length = self.block_size - truncate_length - 1
        ...
        y = torch.tensor([self.stoi[char] for char in output], dtype=torch.long)
        return x, y
        ### END YOUR CODE ###
